          ...
          <div className="flex">
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-10">
              ...
              <div class="flex flex-col items-center pb-10 ">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">
                  <span className="text-black"> Address :</span> {Data.address}
                </span>
                <span class="text-sm text-gray-500 dark:text-gray-400">
              ...
              <div className="border w-2/3 rounded-lg bg-cover">
                        <img src={img == null?Data.extphoto.image1:img} className="bg-cover" alt="" />
                        <div>
                            <button onClick={handlePre}>

                            <img className="w-10 h-10 relative -top-56 -left-9 hover:translate-y-1" src="../arrow1.png" alt="" />
                            </button>
                        </div>
                        <div>
                            <button onClick={handleNext}>

                            <img className="w-10 h-10 relative -top-[260px] left-[800px] hover:translate-y-1" src="../arrow2.png" alt="" />
                            </button>
                        </div>
              </div>
          </div>
